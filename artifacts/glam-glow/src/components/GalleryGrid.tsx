            ...
            <div key={i} className="ig-cell">
              <div className="ig-cell-placeholder" aria-label={label}>
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="2" y="7" width="32" height="24" rx="2" stroke="#B8942E" strokeWidth="1.5" fill="none" />
                  <circle cx="12" cy="15" r="3" stroke="#B8942E" strokeWidth="1.2" fill="none" />
                  <path d="M2 25l9-7 7 5 5-4 11 8" stroke="#B8942E" strokeWidth="1.2" strokeLinejoin="round" fill="none" />
                </svg>
              </div>
